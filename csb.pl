...
$currentprodbranch = "camel-spring-boot-4.10.3-branch";
...
system("export JAVA_HOME=/opt/homebrew/Cellar/openjdk\@21/21.0.6/libexec/openjdk.jdk/Contents/Home; /usr/local/apache-maven-3.9.9/bin/mvn -N -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=com.redhat.camel-spring-boot.AddProductBranchProperties");
...
system("export JAVA_HOME=/opt/homebrew/Cellar/openjdk\@21/21.0.6/libexec/openjdk.jdk/Contents/Home; /usr/local/apache-maven-3.9.9/bin/mvn org.l2x6.cq:cq-camel-spring-boot-prod-maven-plugin:camel-spring-boot-prod-excludes -N");
