...
$currentprodbranch = "camel-kamelets-4.10.6-branch";
...
# Change the version
system("export JAVA_HOME=/opt/homebrew/Cellar/openjdk\@17/17.0.16/libexec/openjdk.jdk/Contents/Home; /usr/local/apache-maven-3.9.9/bin/mvn -DnewVersion=${vers}-SNAPSHOT -DgenerateBackupPoms=false versions:set");
...
system("export JAVA_HOME=/opt/homebrew/Cellar/openjdk\@17/17.0.16/libexec/openjdk.jdk/Contents/Home; /usr/local/apache-maven-3.9.9/bin/mvn -DskipTests clean install");
