...
$currentprodbranch = "camel-4.14.1-branch";
...
system("export JAVA_HOME=/opt/homebrew/Cellar/openjdk\@21/21.0.8/libexec/openjdk.jdk/Contents/Home; /usr/local/apache-maven-3.9.9/bin/mvn org.l2x6.cq:cq-camel-prod-maven-plugin:camel-prod-excludes -N");
